...
### 5.1. Core source-code functions can be found in the .src/ folder
 ...
 - helper functions for decision-trees: 'treehelpers.py'

'Updates':
- 'archs_models.py' updated with DecisionTree, RnadomForest and AdaBoost Classes

### 5.2. According to the question prompts, this assignment 
	is implemented using 3 notebooks for the parts:
- ia4_pt1.ipynb : decision tree only
- ia4_pt2.ipynb : random forest
- ia4_pt3.ipynb : adaboost + kaggle competition
